...
class TeslaCoil extends StatelessWidget {
  const TeslaCoil({super.key, required this.title});
  final String title;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
...
class TeslaCoilQ extends StatefulWidget {
  const TeslaCoilQ({super.key});

  @override
  _TeslaCoilQ createState() => _TeslaCoilQ();
}

class _TeslaCoilQ extends State<TeslaCoilQ> {
  String question =
      "Which floor(s) can this Musical tesla coil be found?"; //change question
  List<String> options = [
    "1",
    "2",
    "3",
  ...
  int correctAnswerIndex = 2; // "3" is correct, changes correct answer
  int? selectedAnswerIndex;
  bool isCorrect = false; // Track if the answer is correct
...
class TrophyWall extends StatelessWidget {
  const TrophyWall({super.key, required this.title});
  final String title;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            // Image
            Image.asset(
              'images/Trophywall(3rdfloor).jpeg', // Replace with appropriate image for question
...
class TrophywallQ extends StatefulWidget {
  const TrophywallQ({super.key});

  @override
  _TrophywallQ createState() => _TrophywallQ();
}

class _TrophywallQ extends State<TrophywallQ> {
  String question =
      "Which floor(s) can this can this wall of trophies be found?"; //change question
  List<String> options = [
    "1",
    "2",
    "3",
  ...
  int correctAnswerIndex = 2; // "1" is correct, changes correct answer
  int? selectedAnswerIndex;
  bool isCorrect = false; // Track if the answer is correct
